...
<head>
	...
	<title>All Advertisments | lkevents.lk</title>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li><a href="all_products.php" class="active">All Advertisment</a></li>
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"  id="products_box"><!--features_items start-->
						...
						while($row_products= mysqli_fetch_array($run_products))
						{
							...
							<a href='index.php?add_cart=$pro_id'><button style='float:right;'>
							Enquiry</button></a>
